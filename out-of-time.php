<?php 
//=========================================================================
// JS RACER TURBO > CLASSIC GAME MODE > OUT OF TIME
//=========================================================================
// Security
define('Security', TRUE); 
// Game
require('includes/core/jsr_core.php');
$jsrgame = new Jsr_Helpers('classic','outoftime');
?>
<!doctype html>
...
<body class="notranslate <?php echo $jsrgame->gamedata['page']['body_class']; ?>">
    ...
    <script src="assets/game/js/game/run-classic-out-of-time.js<?php echo $jsrUrlVersion; ?>"></script>
</body> 
</html>
