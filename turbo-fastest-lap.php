<?php 
//=======================================================
// JS RACER TURBO > TURBO GAME MODE > FASTEST LAP
//=======================================================
// Security
define('Security', TRUE); 
// Game
require('includes/core/jsr_core.php');
$jsrgame = new Jsr_Helpers('turbo','fastestlap');
?>
<!doctype html>
...
<body class="notranslate <?php echo $jsrgame->gamedata['page']['body_class']; ?>">
    ...
    <script src="assets/game/js/game/run-turbo-fastest-lap.js<?php echo $jsrUrlVersion; ?>"></script>
</body> 
</html>
