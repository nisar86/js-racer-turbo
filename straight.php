<?php 
//=======================================================
// JS RACER TURBO > DEMO > STRAIGHT
//=======================================================
// Security
define('Security', TRUE); 
// Game
require('includes/core/jsr_core.php');
$jsrgame = new Jsr_Helpers('demo','straight');
?>
<!doctype html>
...
<body class="notranslate <?php echo $jsrgame->gamedata['page']['body_class']; ?>">
    ...
    <script src="assets/game/js/demo/jsr-straight.js<?php echo $jsrUrlVersion; ?>"></script>
    <script src="assets/game/js/demo/run-demo.js<?php echo $jsrUrlVersion; ?>"></script>
</body>
