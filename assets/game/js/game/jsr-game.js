...
(function($) {
    ...
    function racer(gameplay=null,gamemode=null) {
        ...
        var changeLandscapeEvery    = switch_gm_fo(2,3);            // Change the background image when the indicated laps are matched. Set to 0 to disable.
        ...
        var forceChangeLandscapeContinuous = false;                 // For development, if true it continuously changes the landscape.
        // WEATHER
        ...
        var turboGiveEvery          = changeLandscapeEvery;         // Give a new turbo every x levels (set to 0 to disable).
        ...
        function update(dt) {
            ...
            if (position > playerZ) {
                ...
                if (currentLapTime && (startPosition < playerZ)) {
                    ...
                    if ((changeLandscapeEvery > 0) & (currentLapChangeLandscapeFlag % changeLandscapeEvery == 0)) {
        ...
        var RenderGame = function() {
            ...
            // if forceChangeLandscapeContinuous is enabled.
            if ( forceChangeLandscapeContinuous == true ) {
            ...
            if (!jsr.Vars.changeLandscapeFlag) {
                ...
                if (currentLandscapeBackgroundAlpha >= 1.0) {
                    ...
                    // if forceChangeLandscapeContinuous is disabled.
                    if ( forceChangeLandscapeContinuous == false ) {
