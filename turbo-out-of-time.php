<?php
//=======================================================
// JS RACER TURBO > TURBO GAME MODE > OUT OF TIME
//=======================================================
// Security
define('Security', TRUE); 
// Game
require('includes/core/jsr_core.php');
$jsrgame = new Jsr_Helpers('turbo','outoftime');
?>
<!doctype html>
...
<body class="notranslate <?php echo $jsrgame->gamedata['page']['body_class']; ?>">
    ...
    <script src="assets/game/js/game/run-turbo-out-of-time.js<?php echo $jsrUrlVersion; ?>"></script>
</body> 
</html>
